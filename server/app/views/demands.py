...
def get_some_demands():
    if request.method == 'GET':
        ...
        left join
            (select u_id,case when u_name is null then u_nick end as reviewer from app.users) as t1
        on
...
def do_publish():
    if request.method == 'POST':
        ...
        sql = '''
                ...
                '''
        db.session.execute(sql, {'d_title': d_title, 'd_content': d_content, 'd_publisher': d_publisher, 'd_pub_time': d_pub_time})
